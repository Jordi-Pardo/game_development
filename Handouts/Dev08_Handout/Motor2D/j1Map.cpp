...
void j1Map::PropagateBFS()
{
	...
	if (frontier.start) {
		iPoint lastPoint = frontier.GetLast()->data;
		frontier.Pop(frontier.GetLast()->data);

		frontier.Push(iPoint(lastPoint.x-1, lastPoint.y));
		frontier.Push(iPoint(lastPoint.x +1, lastPoint.y));
		frontier.Push(iPoint(lastPoint.x, lastPoint.y+1));
		frontier.Push(iPoint(lastPoint.x, lastPoint.y-1));
		
		visited.add(iPoint(lastPoint.x-1, lastPoint.y));
		visited.add(iPoint(lastPoint.x+1, lastPoint.y));
		visited.add(iPoint(lastPoint.x, lastPoint.y+1));
		visited.add(iPoint(lastPoint.x, lastPoint.y-1));
